...
%prep
%setup -q -n pyparsing-2.4.4
cd %{_builddir}/pyparsing-2.4.4
...
cp %{_builddir}/pyparsing-2.4.4/LICENSE %{buildroot}/usr/share/package-licenses/pyparsing/df156c6a0a89ed2a3bd4a473c68cf85907509ca0
