...
Source0  : https://files.pythonhosted.org/packages/39/cb/69988a9b62158c85288e7d3aeb5634efd506ca92c8a34dfae3bd2a88943a/pyparsing-3.0.5.tar.gz
...
%prep
%setup -q -n pyparsing-3.0.5
cd %{_builddir}/pyparsing-3.0.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636394433
...
cp %{_builddir}/pyparsing-3.0.5/LICENSE %{buildroot}/usr/share/package-licenses/pyparsing/df156c6a0a89ed2a3bd4a473c68cf85907509ca0
